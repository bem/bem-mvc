...
A model with given parameters will be created after initialization. And changes withing the enter field will automatically appear in the model and vice versa.
