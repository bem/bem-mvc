...
**В связи с активной разработкой в библиотеках `bem-core` и `bem-components` некоторая функциональность может работать некорретно! Мы работаем над стабилизацией и не откажемся от любой помощи в этом.**
